 ...
 * @author joca
 */
public class EventActionsForm extends javax.swing.JInternalFrame {
     ...
     */
    public EventActionsForm(FramePrincipal pane) {
        initComponents();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            ...
            framePrincipal.printOnLog( events.size() + " Eventos encontrados.");
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        EventUpdateForm eventUpdateForm = new EventUpdateForm(framePrincipal, UpdateTypeEnum.CREAR);
        framePrincipal.openNewWindow(eventUpdateForm);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            int confirm = JOptionPane.showConfirmDialog(this,
                    "Eliminar evento con código " + id + " ?", "Confirmar eliminación",
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        Event event;
        try {
            event = eventService.getEventByID(searchBar.getText());
            EventUpdateForm eventUpdateForm = new EventUpdateForm(event, event.getId(), framePrincipal, UpdateTypeEnum.ACTUALIZAR);
            framePrincipal.openNewWindow(eventUpdateForm);
        } catch (NotFoundException | SQLException ex) {
            framePrincipal.printOnLog("Error al intentar actualizar el evento - " + ex.getMessage());
        }
    ...
    private void searchBarCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_searchBarCaretUpdate
        EventService eventService = new EventService(new EventDB());
        try {
            boolean isEventAvailable = !eventService.isKeyInUse(searchBar.getText());
            if (isEventAvailable) {
                editButton.setEnabled(false);
                deleteButton.setEnabled(false);
            } else {
