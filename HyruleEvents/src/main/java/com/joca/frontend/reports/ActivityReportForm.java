 ...
 * @author joca
 */
public class ActivityReportForm extends javax.swing.JInternalFrame {
     ...
     */
    public ActivityReportForm(FramePrincipal pane) {
        initComponents();
        this.framePrincipal = pane;
        this.typeCombo.setModel(new DefaultComboBoxModel(ActivityTypeEnum.values()));
    }
    ...
    private void initComponents() {
        ...
        typeCheckBox.setText("Tipo de actividad");
        ...
        emailCheckBox.setText("Correo del encargado");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(emailSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(128, 128, 128)
    ...
    private void generateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateButtonActionPerformed
        ...
        try {
            framePrincipal.saveHtml(reportsService.getActivitiesReport(getFilters(), idSearchBar.getText()), LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd-HH:mm:ss")) + "__" + idSearchBar.getText() + ".html");
    ...
    private List<Filter> getFilters() {
        ...
        if (typeCheckBox.isSelected()) {
            filters.add(new Filter("a.type", ((ParticipantTypeEnum) typeCombo.getSelectedItem()).name(), FilterTypeEnum.EQUAL));
        }
        if (emailCheckBox.isSelected()) {
            filters.add(new Filter("a.speaker_email", emailSearch.getText(), FilterTypeEnum.EQUAL));
        }
        return filters;
    }
