 ...
 * @author joca
 */
public class RegistrationUpdateForm extends javax.swing.JInternalFrame {
     ...
     * @param type
     */
    public RegistrationUpdateForm(FramePrincipal framePrincipal, UpdateTypeEnum type) {
    ...
    public RegistrationUpdateForm(Registration registration, String originalEventId, String originalParticipantEmail, FramePrincipal framePrincipal, UpdateTypeEnum type) {
