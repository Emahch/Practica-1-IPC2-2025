...
public class OneKeyService {
    private OneKey dbAccess;

    public OneKeyService(OneKey dbAccess) {
        this.dbAccess = dbAccess;
    }

    public void create(Entity entity) throws SQLException, DuplicatedKeyException, NotRowsAffectedException {
